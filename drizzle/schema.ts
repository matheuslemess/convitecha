 ...
 */
export const guestConfirmations = mysqlTable("guest_confirmations", {
  id: int("id").autoincrement().primaryKey(),
  fullName: varchar("fullName", { length: 255 }).notNull(),
  numberOfCompanions: int("numberOfCompanions").notNull().default(0),
  confirmationStatus: mysqlEnum("confirmationStatus", ["yes", "no", "maybe"]).notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
});
